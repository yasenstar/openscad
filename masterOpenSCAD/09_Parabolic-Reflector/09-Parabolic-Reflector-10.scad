...
module parabola( focus_point, base_area, resolution = [10, 10] ) {
    ...
    side_faces_2 = [
        ...
        [
            x + last_row,
            x + 1 + last_row,
            x + 1 + size_ppoints + last_row,
            x + size_ppoints + last_row
        ]
    ];
    ...
    side_faces_4 = [
        ...
        [
            y * size_x + last_col,
            (y+1) * size_x + last_col,
            (y+1) * size_x + size_ppoints + last_col,
            y * size_x + size_ppoints + last_col
        ]
    ];
    
    polyhedron(
        points = concat( parabola_points, base_points ),
        faces = concat( parabola_faces, base_faces, side_faces_1, side_faces_2, side_faces_3, side_faces_4)
    );
